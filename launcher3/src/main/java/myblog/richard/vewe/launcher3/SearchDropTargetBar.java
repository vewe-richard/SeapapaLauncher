...
//        mUser = (ImageView)findViewById(R.id.userview);
...
/*    public boolean isLeftTimeVisiable()
    {
        return (mLeftTime.getVisibility() == View.VISIBLE);
    }

    public void showLeftTime(boolean show)
    {
        if(show) {
            mLeftTime.setVisibility(VISIBLE);
        }
        else
        {
            mLeftTime.setVisibility(INVISIBLE);
        }
    }

    public void changeIcon(boolean parentControl)
    {
        if(parentControl){
            mUser.setImageDrawable(getResources().getDrawable(R.drawable.child));
        }
        else
        {
            mUser.setImageDrawable(getResources().getDrawable(R.drawable.ic_parent_control));
        }
    }
    ...
    {
        String show;
        String head, minute, second;
        minute = getResources().getString(R.string.lefttime_minute);
        second = getResources().getString(R.string.lefttime_second);
        if(lefttime > 0) {
            head = getResources().getString(R.string.lefttime_activate);
            show = head + "\n" + (lefttime / 60) + minute + (lefttime % 60) + second;
        }
        else {
            lefttime = -lefttime;
            head = getResources().getString(R.string.lefttime_negative);
            show = head + "\n" + (lefttime / 60) + minute + (lefttime % 60) + second;
        }
        mLeftTime.setText(show);
    }

    public void setUserOnClick(OnClickListener listener)
    {
        mUser.setOnClickListener(listener);
    }

    public void setLeftTimeOnClick(OnClickListener listener)
    {
        mLeftTime.setOnClickListener(listener);
    }*/
