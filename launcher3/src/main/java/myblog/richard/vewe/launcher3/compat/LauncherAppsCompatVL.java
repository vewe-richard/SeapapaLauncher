...
package  myblog.richard.vewe.launcher3.compat;
...
import myblog.richard.vewe.launcher3.Launcher;
import myblog.richard.vewe.launcher3.LauncherApplication;
...
public class LauncherAppsCompatVL extends LauncherAppsCompat {
    ...
    LauncherAppsCompatVL(Context context) {
        ...
        else if(context instanceof Activity)
        {
            ...
            {
                mLauncherApplication = (LauncherApplication)app;
            }
        }
    }
    ...
    public List<LauncherActivityInfoCompat> getActivityList(String packageName,
        ...
        for (LauncherActivityInfo info : list) {
            compatList.add(new LauncherActivityInfoCompatVL(info, mLauncherApplication.getPrefix(info.getComponentName().getPackageName())));
        }
        return compatList;
    }
    ...
    public LauncherActivityInfoCompat resolveActivity(Intent intent, UserHandleCompat user) {
        ...
        if (activity != null) {
            return new LauncherActivityInfoCompatVL(activity, mLauncherApplication.getPrefix(activity.getComponentName().getPackageName()));
        } else {
            return null;
        }
    }
