...
public class LauncherAppsCompatV16 extends LauncherAppsCompat {
    ...
    public List<LauncherActivityInfoCompat> getActivityList(String packageName,
        ...
        for (ResolveInfo info : infos) {
            list.add(new LauncherActivityInfoCompatV16(mContext, info, mLauncherApplication.getPrefix(info.activityInfo.packageName)));
        }
        return list;
    }
    ...
    public LauncherActivityInfoCompat resolveActivity(Intent intent, UserHandleCompat user) {
        ...
        if (info != null) {
            return new LauncherActivityInfoCompatV16(mContext, info, mLauncherApplication.getPrefix(info.activityInfo.packageName));
        }
        return null;
    }
